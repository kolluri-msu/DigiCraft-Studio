...
document.getElementById("horizontalCutBtn").addEventListener("click", () => {
  horizontalCutMode = true;
  drawMode=false;
  console.log("Horizontal cut mode activated");
});

document.getElementById("verticalCutBtn").addEventListener("click", () => {
  verticalCutMode = true;
  drawMode=false;
  console.log("Vertical cut mode activated");
});

document.getElementById("slantCutBtn").addEventListener("click", () => {
  slantCutMode = true;
  drawMode = false;
  console.log("Slant cut mode activated");
});

document.getElementById("curvedCutBtn").addEventListener("click", () => {
  curvedCutMode = true;
  drawMode = false;
